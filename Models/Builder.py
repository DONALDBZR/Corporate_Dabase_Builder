...
class Builder:
    ...
    def sanitizeBusinessDetailOperationalAddressMissingAddress(self) -> None:
        ...
        Returns:
            void
        """
        missing_addresses: List[BusinessDetails] = [business_details for business_details in self.getBusinessDetailsData() if business_details.operational_address == "Mauritius" of business_details.operational_address == "() Mauritius"]
