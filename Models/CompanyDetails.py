...
class Company_Details(Database_Handler):
    ...
    def updateCorporateMetadataAuthorisedCompany(self, data: Dict[str, Union[str, int]], identifier: int) -> int:
        """
        Updating the Corporate Metadata for an authorised company.
