...
class StateCapital:
    ...
    state_capital: Union[float, None]
    ...
    def __init__(self, dataset: Union[RowType, Dict[str, Union[int, str, float, None]]]) -> None:
        ...
        Parameters:
            dataset: {identifier: int, CompanyDetail: int, type: string|null, amount: int|null, state_capital: float|null, amount_unpaid: float|null, currency: string|null}: The result set from the relational database server.
        ...
        self.state_capital = dataset["state_capital"] # type: ignore
